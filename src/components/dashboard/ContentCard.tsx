...
interface ContentCardProps {
  ...
  /** URL para abrir a execução no n8n (quando disponível) */
...
export function ContentCard({
  ...
  const formattedDate = new Intl.DateTimeFormat("pt-BR", {
    ...
    content.createdAt instanceof Date ? content.createdAt : new Date(content.createdAt)
  );
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            {content.executionStatus && content.executionStatus !== "CONCLUÍDO" && (
          ...
          {(executionUrl ?? content.n8nExecutionUrl) && (
            <a
              href={executionUrl ?? content.n8nExecutionUrl ?? "#"}
              target="_blank"
